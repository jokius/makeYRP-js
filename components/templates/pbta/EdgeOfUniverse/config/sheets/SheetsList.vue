...
import RoleModal from '~/components/templates/pbta/EdgeOfUniverse/config/sheets/RoleModal'
import RoleMovesModal from '~/components/templates/pbta/EdgeOfUniverse/config/sheets/RoleMovesModal'
import RoleItemsModal from '~/components/templates/pbta/EdgeOfUniverse/config/sheets/RoleItemsModal'
import RoleRelationshipModal from '~/components/templates/pbta/EdgeOfUniverse/config/sheets/RoleRelationshipModal'
import RoleSpecialsModal from '~/components/templates/pbta/EdgeOfUniverse/config/sheets/RoleSpecialsModal'
