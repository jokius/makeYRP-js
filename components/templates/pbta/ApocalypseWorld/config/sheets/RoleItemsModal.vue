            ...
            <tr v-for="(item, index) in selectEquipment[select.index].items"
              ...
              <td class="actions cell">
                <v-btn
                  color="indigo"
                  dark
                  @click="showModal({ ...item, restore: true },
...
import RoleItemModal from '~/components/templates/pbta/ApocalypseWorld/config/sheets/RoleItemModal'
import SelectItemModal from '~/components/templates/pbta/ApocalypseWorld/config/sheets/SelectItemModal'
...
export default {
  ...
  created() {
    ...
    if (!this.customTables.startingEquipment) {
      this.$store.commit('gameConfig/update',
        { path: `customTemplate.tables.startingEquipment`, value: {} })
    }
    ...
    if (!this.customTables.selectEquipment) {
      this.$store.commit('gameConfig/update',
        { path: `customTemplate.tables.selectEquipment`, value: {} })
    }
  ...
  methods: {
    ...
    changeItem(item) {
      ...
      console.log('this.customTables', this.customTables)
      ...
      this.$store.commit('gameConfig/update',
        { path: `customTemplate.tables.${this.group}`, value: items })
    },
    ...
    removeItem(index, group) {
      this.$store.commit('gameConfig/update',
        { path: `customTemplate.tables.${group}`, value: index, remove: true })
    },
